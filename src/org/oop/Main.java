...
public class Main {
    ...
    System.out.println(prodotto2.getCodeAndName());
        ...
        Prodotto prodotto3 = new Prodotto("Power Bank", "Tascabile",20);
        System.out.println("Il codice del tuo prodotto è: "+prodotto3.codice);
        System.out.println(prodotto3.getCodeAndName());
    }
